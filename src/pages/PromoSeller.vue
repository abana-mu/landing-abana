    ...
    <div id="parallax-over" class="relative z-1 bg-white">
      <div id="banner" class="relative w-full flex flex-col md:flex-row justify-center bg-white">
        <div class="contain lg:h-full w-full flex flex-col justify-between z-10 ">
          <div class="w-full pt-24 pb-20 h-full text-center md:text-left flex flex-col justify-center items-center md:items-start">
            <div class="marketing text-4xl lg:text-5xl lg:leading-normal font-medium mb-6 max-w-5xl mx-auto text-title text-center mb-10" data-aos="fade-up" data-aos-duration="800">
              Connect to new <b>Buyers, Yarn, Fabric & Trims Suppliers, and Service Providers</b>
            </div>

            <div class="max-w-3xl mx-auto text-2xl mb-10 text-center">
              ABANA is a one-stop shop inclusively connecting all industry players throughout the full supply chain. Join our network and be visible to international buyers looking for reliable
              partners in Africa.
            </div>
      ...
      <div class="bg-gray-50">
        <div class="contain py-24">
          <div class="text-3xl lg:text-4xl mb-4 font-bold text-title text-center mb-24">Fast and Easy!</div>
          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            ...
            <div>
              ...
              <div class="text-2xl">Showcase your Product</div>
            </div>
            <div>
              ...
              <div class="text-2xl">Respond to quotes</div>
            </div>
            <div>
              ...
              <div class="text-2xl">Build new partnerships</div>
            </div>
          </div>
        </div>
      </div>
