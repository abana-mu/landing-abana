      ...
      <div id="tabs" class="mx-auto">
        ...
        <div class="bg-secondary-400 flex flex-col items-center justify-center py-5">
          <div class="flex flex-row justify-center mb-6">
            <a class="btn-price text-2xl px-6" v-on:click="activetab = index" v-bind:class="[activetab === index ? 'active' : '']" v-for="(tabs, index) in Plans" :key="tabs.index">{{ tabs.title }}</a>
          </div>
                        ...
                        <div class="flex-1 text-center m-0 py-4 border-l" v-for="subs in tabs.subs" :key="subs.name">
                          ...
                          <div class="mb-0 text-xl font-medium">
                            ...
                            <div v-else-if="subs.name === 'basic'">
                              <div>
                                <span>Free </span><span class="text-sm">(usually USD${{ subs.price[currentPrice] }}/mo)</span>
                              </div>
                            </div>
...
export default {
  ...
  metaInfo: {
    ...
    meta: [
      {
        name: 'description',
        content: 'Choose the plan that is right for you and your business. Join as a free buyer to access our ecommerce solutions or subscribe to access a world of features to help your business.',
      },
    ],
  },
  data() {
