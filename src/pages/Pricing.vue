<template>
  <Layout class="one-section-tight-layout">
    <div class="mobile-gutter">
      <h1 class="text-5xl text-center font-medium mb-4">{{ Data.header.title }}</h1>
                ...
                <div class="grid grid-cols-1 gap-4" :class="index === 'seller' ? 'md:grid-cols-3' : 'md:grid-cols-2'">
                  ...
                  >
                    ...
                    <div class="text-4xl font-medium mb-4">
                      ...
                      <div v-else><span class="text-caption  font-thin text-xl">US</span> ${{ card.price[currentPrice] }}/mo</div>
                    </div>
                    ...
                    <ul class="mt-4 pl-0 text-caption text-sm">
                  ...
                  <div class="flex sticky pl-5 bg-gray-50 border top-24 rounded z-1">
                    ...
                    <div class="w-2/2 flex flex-row flex-1">
                      <div class="flex-1 text-center m-0 py-4 border-l" v-for="subs in tabs.subs" :key="subs.name">
                        <div class="text-caption uppercase text-xs font-medium tracking-wider border-0 text-center">
                          {{ subs.name }}
                        </div>
