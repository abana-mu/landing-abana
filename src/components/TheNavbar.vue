        ...
        <div class="mx-auto max-w-7xl lg:px-5 lg:py-4">
          <div class="nav-inner bg-white relative px-4 xs:px-5 sm:px-6 lg:px-5 py-4 lg:py-0 flex justify-between items-center space-x-6 xl:space-x-10 z-20">
            <div class="flex flex-row items-center space-x-10">
              ...
              <nav class="space-x-4 hidden lg:flex">
                ...
                >
                  <!-- Links w/ Dropdown -->
                  <div v-if="link.drop">
                    <div :class="link.name" class="inline-flex items-center text-base text-title group-hover:text-title">
                      <span>{{ link.name }}</span>
                      <svg
                            ...
                            <div class="col-span-2 bg-gray-50 py-8 px-10">
                              ...
                              <div class="flex flex-col justify-center space-y-4">
                                <div v-for="(drop, index) in link.drop.extra" :key="drop + index">
                                  <a v-if="drop.title == 'Carbon Offset'" href="/documents/ABANA_Carbon_Emissions.pdf" target="_blank" class="drop-item flex items-center cursor-pointer">
                  ...
                  <!-- Links w/o Dropdown -->
                  <div v-else class="inline-flex items-center text-base text-title group-hover:text-title">
            ...
            <div class="hidden lg:flex items-center justify-end md:flex-1 lg:w-0 divide-x divide-gray-300">
              <a href="https://meetings.hubspot.com/abana" target="_blank" class="whitespace-nowrap text-base text-primary hover:text-primary-400 hover:underline mr-4">Book a Demo</a>
              <div class="pl-4 space-x-4">
                <a href="https://app.abana.mu/login" class="whitespace-nowrap text-base font-regular text-body hover:text-title hover:underline">Log in</a>
                <g-link to="/registration/" class="whitespace-nowrap inline-flex items-center justify-center btn btn-primary">Register</g-link>
              </div>
            </div>
            <!-- Hamburger -->
            ...
            <div class="contain pt-5">
              <div v-for="(link, index) in Nav" :key="link.name + index">
                <div v-if="link.drop">
                  ...
                  <!-- SIDEBAR 2 -->
                  <div :id="'sidebar-2-' + link.name.toLowerCase()" class="absolute w-full h-full top-0 left-0 bg-gray-50 z-20 transition sidebar-2-hide">
                    <div class="contain pt-5">
                      <div class="inline-flex items-center cursor-pointer mt-2 mb-6 hover:text-primary" @click="toggleSideBar2(link.name.toLowerCase())">
                        <!-- Arrow left-short -->
                      ...
                      <template v-if="link.drop.type === 1">
                        ...
                        <div v-for="(link, index) in link.drop.links" :key="link.title + index">
                          <g-link :to="link.link" class="drop-item w-full p-3 -ml-3 inline-flex hover:bg-primary-100 rounded-md items-center font-medium text-body hover:text-primary cursor-pointer">
                        ...
                        <div v-for="(link, index) in link.drop.extra" :key="link.title + index">
                          ...
                          <g-link v-else :to="link.link" class="drop-item w-full p-3 inline-flex hover:bg-primary-100 rounded-md items-center text-body hover:text-primary cursor-pointer">
                            <component :is="link.icon" class="drop-item-icon h-6 w-6 mr-4" />
                      ...
                      <template v-else>
                        <div v-for="(col, index) in link.drop.columns" :key="col.header + index" class="mb-6">
                          ...
                          <div v-for="(link, index) in col.links" :key="link.title + index">
                            ...
                            <template v-else>
                              <g-link :to="link.link" class="drop-item w-full p-3 inline-flex hover:bg-primary-100 rounded-md items-center text-body hover:text-primary cursor-pointer">
                                <component :is="link.icon" class="drop-item-icon h-6 w-6 mr-4" />
                                <span class="text-base">{{ link.title }}</span>
                              </g-link>
                            </template>
        ...
        seller: {
          ...
          drop: {
            ...
            links: [
              ...
              {
                title: 'Yarn, Fabric, Accessories & Equipment suppliers',
