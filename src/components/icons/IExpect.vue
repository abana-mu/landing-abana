...
<template>
  <svg class="box-img" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78.97 78.97">
    ...
    <path class="dark" fill="currentColor" d="M27.2,37.8h-1.4c-2,0-3.7,1.6-3.7,3.7c0,0,0,0,0,0v6.8c0,2,1.6,3.7,3.7,3.7h1.4V37.8z" />
    <path
      class="light"
      fill="currentColor"
      d="M29.9,51.9l2.8,2c1.3,0.9,2.9,1.4,4.5,1.4h10.9c2,0,3.8-1.3,4.5-3.2l4-11.1c0.9-2.5-0.4-5.2-2.9-6.1
