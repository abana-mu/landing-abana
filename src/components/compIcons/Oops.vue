...
<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 110.9 93.4"
    style="enable-background:new 0 0 110.9 93.4;"
    xml:space="preserve"
  >
    <path
      class="oops-1"
      d="M94.7,86H17.2c-2.1,0-3.8-1.7-3.8-3.8v0c0-2.1,1.7-3.8,3.8-3.8h77.6c2.1,0,3.8,1.7,3.8,3.8v0
	C98.5,84.3,96.8,86,94.7,86z"
    />
    <g>
      <path
        class="oops-2"
        d="M22.1,50.1c0-5.5,1.2-10.4,3.7-15.1c1.2-2.2,2.7-4.3,4.4-6.1c2.6-2.8,5.6-5.1,9-6.8c2.9-1.5,6-2.5,9.2-2.9
